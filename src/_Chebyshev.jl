...
# https://github.com/nep-pack/NonlinearEigenproblems.jl/blob/6d91752393adbe26e17a1fedfddc5dbcec71304c/docs/src/hydro_cheb/chebdif.jl
...
function chebdif(N, M)
    ...
    n1 = Int(floor(N / 2))
    n2 = Int(ceil(N / 2))     # Indices used for flipping trick.
